...
import static io.github.fiftieshousewife.cleanlogging.LoggerNames.COMMONS_LOG_FACTORY;
import static io.github.fiftieshousewife.cleanlogging.LoggerNames.LOG4J2_LOGGER;
import static io.github.fiftieshousewife.cleanlogging.LoggerNames.LOG4J2_LOG_MANAGER;
import static io.github.fiftieshousewife.cleanlogging.LoggerNames.SLF4J_LOGGER;
import static io.github.fiftieshousewife.cleanlogging.LoggerNames.SLF4J_LOGGER_FACTORY;
...
final class RemoveUnusedLoggerImports {
    ...
    static List<J.Import> stillUsedImports(final J.CompilationUnit compilationUnit) {
        final List<J.Import> imports = compilationUnit.getImports();
        if (imports.stream().noneMatch(imp -> CANDIDATES.contains(imp.getTypeName()))) {
            return imports;
        }
