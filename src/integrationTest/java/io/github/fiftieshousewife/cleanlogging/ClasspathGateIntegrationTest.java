 ...
 * {@link io.github.fiftieshousewife.cleanlogging.LombokClasspathGateTest} at
    ...
    public void defaults(RecipeSpec spec) {
        spec.beforeRecipe(withToolingApi())
                .recipe(Environment.builder()
                        ...
                        .build()
                        .activateRecipes("io.github.fiftieshousewife.cleanlogging.JavaTransformsClasspathGated"));
    }
